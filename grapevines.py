...
#U-Number: U82076898
#Description: Rows of Grapevines - Assignment 1 Length of row, amount of space and the space between each vine is taken as an input from the user. 
#Formula is then used to find out the how many vines can fit.
#-----------------------------------------------
